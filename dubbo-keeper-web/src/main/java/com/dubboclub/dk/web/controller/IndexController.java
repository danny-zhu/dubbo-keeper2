...
public class IndexController {
    ...
    @RequestMapping("/loadAppsType.json")
    ...
    @RequestMapping("/loadServiceProtocols.json")
    ...
    @RequestMapping("/loadAppServices.json")
    ...
    @RequestMapping("/loadAppNodes.json")
    ...
    @RequestMapping("/loadAppsDependencies.json")
    @ResponseBody
