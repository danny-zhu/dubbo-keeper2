...
//    @Qualifier("statisticsStorage")
    ...
    @RequestMapping("/{application}/{service}/{method}/{startTime}-{endTime}/monitors.json")
    public @ResponseBody
    ...
    @RequestMapping("/{application}/{service}/now.json")
    public @ResponseBody
    ...
    @RequestMapping("/{application}/{service}/{startTime}-{endTime}/monitors.json")
    public @ResponseBody
    ...
    @RequestMapping("/{application}/{dayRange}/info.json")
    public @ResponseBody
    ...
    @RequestMapping("/{application}/{dayRange}/overview.json")
    public @ResponseBody
    ...
    @RequestMapping("/{application}/{service}/{dayRange}/overview.json")
    public @ResponseBody
    ...
    @RequestMapping("/{application}/{dayRange}/services.json")
    public @ResponseBody
