...
public class ProviderController {
    ...
    @RequestMapping("/{serviceKey}/providers.json")
    ...
    @RequestMapping("/{applicationName}/{host}/providers.json")
    ...
    @RequestMapping("/{serviceKey}/service-readme.json")
    ...
    @RequestMapping("/{id}/provider-detail.json")
    public @ResponseBody Provider loadProviderDetail(@PathVariable("id")long id){
        return providerService.getProviderById(id);
    }


    @RequestMapping(value = "/edit-provider.json",method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/{id}/{type}/operate.json",method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/{type}/batch-operate.json",method = RequestMethod.POST)
